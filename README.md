...
## 프로젝트 목적
부산시 주택가 불연성쓰레기 수거함 도입을 위한 현황 조사 최적 입지 분석 및 모델링
## 프로젝트 계획 이유
- 산발적인 전용 마대 판매처
...
- 예측 모델을 생성하기 위하여 5개년 데이터로 불연성쓰레기 양과 상관관계가 있는 변수 이용
    - 불연성쓰레기양, 세대수, 주택수, 인구
...
- 최종 입지 선정된 구역을 머신러닝을 통하여 불연성쓰레기 양 예측 모델을 생성
...
![Method별 계층적 군집](img/Method별계층적군집.png)

#### 군집 수 선정
Dendrogram(계층도)를 참고하여 총 16개 구군을 3개의 군집으로 선정

![군집수선정](img/군집수선정.png)
...
![가중치도출결과](img/가중치도출결과.png)
